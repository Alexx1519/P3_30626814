...
const transporter = nodemailer.createTransport({
  service:'Gmail',
  auth:{
    user:'trumpettopoalex@gmail.com',
    pass:'agvr ecgs ahcb sski'
  }
});
    ...
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
      ...
      res.render('clientes.ejs',{
        producto:rowsProduct,
         og: {
      title: 'Nutribost',
      description: 'Productos dieteticos',
...
function loginUsers(req,res){
  res.render('loginUsers.ejs',{
    og: {
      title: 'Nutriboost',
      description: 'Productos dieteticas',
      image: 'https://www.amomikitchenaid.com/wp-content/uploads/2018/11/KitchenAid_Batedeira_KEA25AH_Imagem_Ambientada_3-800x533.png',
      // Otros metadatos OGP que desees especificar
      }
  });
...
function registroUsuariosPost(req,res){
 ...
 const mensaje = {
  from:'trumpettopoalex@gmail.com',
  to:email,
  subject:'!Bienvenido¡',
...
db.run(sql,[nombre_de_usuario,apellido,cedula,telefono,cliente_id,producto_id,cantidad,total_pagado,ip_cliente,codigo,numeroT,cvv,mesV,year,currency,descripcion],(err)=>{
  if(err) return console.error(err.message);
     ...
     const mailOptions = {
    from: 'trumpettopoalex@gmail.com', // Reemplaza con tu dirección de correo electrónico
